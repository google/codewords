...
namespace CodeWordsJS {
  ...
  export class IdentifierExpressionType extends LeafExpressionType {
    constructor() {
      super('IDENTIFIER', IdentifierExpressionFactoryFn);
    }
  }

  function IdentifierExpressionFactoryFn(lang: CodeLanguage,
                                         type: ExpressionType,
                                         config: IdentifierExpressionConfig) {
    return new IdentifierExpression(lang, type, config);
  }
}
